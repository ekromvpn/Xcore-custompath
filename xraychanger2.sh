...
echo -e "\e[36m╘════════════════════════════════════════════╛\033[0m
\033[1;37mXray-core Changer By EKROMVPNSSH\033[0m
...
1)
clear
mv $xrays_path $xrays_path.bakk && wget -q -O $xrays_path "https://github.com/ekromvpn/Xcore-custompath/releases/download/Xray-linux-64-v1.5.4/Xray-linux-64-v1.5.4" && chmod 755 $xrays_path && xray version
read -p "$( echo -e "Press ${orange}[ ${NC}${green}Enter${NC} ${CYAN}]${NC} Back to menu . . .") "
xraychanger2
;;
2)
clear
mv $xrays_path $xrays_path.bakk && wget -q -O /usr/local/bin/xray "https://github.com/ekromvpn/Xcore-custompath/releases/download/Xray-linux-64-v1.6.1/Xray-linux-64-v1.6.1" && chmod 755 $xrays_path && xray version
read -p "$( echo -e "Press ${orange}[ ${NC}${green}Enter${NC} ${CYAN}]${NC} Back to menu . . .") "
xraychanger2
;;
3)
clear
mv $xrays_path $xrays_path.bakk && wget -q -O $xrays_path "https://github.com/ekromvpn/Xcore-custompath/releases/download/Xray-linux-64-v1.7.2/Xray-linux-64-v1.7.2" && chmod 755 /usr/local/bin/xray && xray version
read -p "$( echo -e "Press ${orange}[ ${NC}${green}Enter${NC} ${CYAN}]${NC} Back to menu . . .") "
xraychanger2
;;
4)
clear
mv $xrays_path $xrays_path.bakk && wget -q -O $xrays_path "https://github.com/ekromvpn/Xcore-custompath/releases/download/Xray-linux-64-v1.7.5/Xray-linux-64-v1.7.5" && chmod 755 $xrays_path && xray version
read -p "$( echo -e "Press ${orange}[ ${NC}${green}Enter${NC} ${CYAN}]${NC} Back to menu . . .") "
xraychanger2
;;
5)
clear
mv $xrays_path $xrays_path.bakk && wget -q -O $xrays_path "https://github.com/ekromvpn/Xcore-custompath/releases/download/Xray-linux-64-v1.8.4/Xray-linux-64-v1.8.4" && chmod 755 $xrays_path && xray version
read -p "$( echo -e "Press ${orange}[ ${NC}${green}Enter${NC} ${CYAN}]${NC} Back to menu . . .") "
xraychanger2
;;
6)
...
77)
clear
mv $xrays_path $xrays_path.bakk && wget -q -O $xrays_path "https://github.com/ekromvpn/Xcore-custompath/releases/download/Xray-linux-64-v1.6.5.1/Xray-linux-64-v1.6.5.1" && chmod 755 $xrays_path && xray version
read -p "$( echo -e "Press ${orange}[ ${NC}${green}Enter${NC} ${CYAN}]${NC} Back to menu . . .") "
xraychanger2
;;
88)
clear
mv $xrays_path $xrays_path.bakk && wget -q -O $xrays_path "https://github.com/ekromvpn/Xcore-custompath/releases/download/Xray-linux-64-v1.7.2-1/Xray-linux-64-v1.7.2-1" && chmod 755 $xrays_path && xray version
read -p "$( echo -e "Press ${orange}[ ${NC}${green}Enter${NC} ${CYAN}]${NC} Back to menu . . .") "
xraychanger2
;;
99)
